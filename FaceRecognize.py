...
print('Creating  neural networks and loading parameters')
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out = cv2.VideoWriter('3F_0726.avi', fourcc, fps=30, frameSize=(200,720))
        ...
        while True:
            ...
            frame = cv2.resize(frame, (0,0), fx=1.0, fy=1.0)    #resize frame (optional)
